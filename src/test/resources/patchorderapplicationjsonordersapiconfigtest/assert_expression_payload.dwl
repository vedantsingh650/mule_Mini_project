...
payload must equalTo({
  ...
  "items": [
    {
      "exception": {
        "localizedMessage": "'8015g000002r12X' is not a valid Salesforce ID for the type Order Product INVALID_ID_FIELD",
        "cause": null,
        "message": "'8015g000002r12X' is not a valid Salesforce ID for the type Order Product INVALID_ID_FIELD",
        "stackTrace": [
          {
      ...
      "message": "'8015g000002r12X' is not a valid Salesforce ID for the type Order Product",
      "payload": {
        "success": false,
        "id": null,
        "errors": [
